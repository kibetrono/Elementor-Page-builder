...
class Social_Admin {
	...
	public function swske_social_share_admin_menu(){
		...
		add_submenu_page( 'social-networks', 'Social Share Sub Page', 'How To Display', 'manage_options', 'social-networks_display_settings',array($this,'swske_social_share_display_callable'));
		...
		add_submenu_page( 'social-networks', 'Social Share Sub Page', 'Documentation', 'manage_options', 'social-networks_documentation',array($this,'swske_social_share_documentation_callable'));

	}
	public function swske_social_admin_callable(){
		require_once 'partials/social-admin-display2.php';
	}
	public function swske_social_share_display_callable(){
		require_once 'partials/social-display-settings.php';
	}
	public function swske_social_share_documentation_callable(){
		require_once 'partials/social-documentation.php';
	}
	...
	public function swske_register_custom_field_values(){
		...
		// post type
		register_setting( 'myownposttypes', 'swsketheposts' );
		register_setting( 'myownposttypes', 'swskethepages' );
		register_setting( 'myownposttypes', 'thelandingpages' );
		register_setting( 'myownposttypes', 'thetemplates' );
		// button sizes
		
		register_setting( 'myownbuttonsize', 'thebuttonsize' );
		// button color
		register_setting('myownbuttoncolor','thecolor');
		// icon arrangement
		register_setting('myownarrangement','the_arrangement_order');

		// button position
		register_setting('myownbtnposition','thebelow');
		register_setting('myownbtnposition','thefloating');
		register_setting('myownbtnposition','theafter');
		register_setting('myownbtnposition','thebefore');
		register_setting('myownbtnposition','theinside');	
	}
